...
- **Workspace runtime**: both workspaces are associated with a shared, dedicated workspace gateway.
...
> [!NOTE]
> API Management workspaces don't support MCP servers directly, so each MCP server is created at the **service level** and routes through a proxy to the workspace-owned API. See the organizational guide for default and dedicated workspace gateway options.

### Organization and APIOps guide

For guidance on adopting this pattern across multiple teams, see the [federated A2A and MCP platform guide](docs/README.md). It covers:

- architecture and ownership boundaries;
- workspace onboarding and shared API/MCP publication;
- APIOps repository, review, promotion, drift, and rollback practices;
- identity, policy, security, observability, reliability, and incident operations.
